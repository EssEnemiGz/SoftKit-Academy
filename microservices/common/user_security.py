...
def logged_warning(secret_key, email):
    ...
    r = requests.put("http://127.0.0.1:6666/security/logged", headers={"Content-Type":"application/json", "Accept":"application/json", "Authorization":f"Bearer {token}"}, json={"email":email})
    return r